...
- 当前缺口：WSL、GPU、NVHPC 24.11 和 NVHPC OpenMPI 4 已恢复；`mpifort` debug 构建 exit 0，`np=1 exact1`（RMS `1.7470e-13`、Linf `2.8821e-13`）和 manufactured（RMS `2.6010e-13`、Linf `3.8480e-13`）均通过，cross 均为 `0`。仍缺 np=2 exact1/manufactured、release 构建、五次正式绝对计时、P=1 cuSPARSE adapter/回执。
