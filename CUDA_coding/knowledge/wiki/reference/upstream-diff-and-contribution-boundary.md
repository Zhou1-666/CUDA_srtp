...
本项目的三对角核心在初始协作基线中可精确回溯到 PaScaL_TDMAcuda 历史 commit；五对角实现不在冻结上游公开树中，因而是相对上游的扩展。导师苏运德于 2026-08-20 确认：导入前初始五对角实现由李洋在其指导的研究生团队三对角源码基础上借助 AI 工具扩展形成。不得把“相对上游新增”或该导入前实现写成后续执行者的“从零原创”。
...
4. TASK-002A 的作者/贡献边界已由导师确认；TASK-002B 仍须单独核验许可、NOTICE 和公开范围；
