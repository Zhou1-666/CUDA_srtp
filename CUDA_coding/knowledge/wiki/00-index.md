...
- Gate：G0——可信基线与项目治理；
- 已通过：TASK-001 的干净构建和 `np=1/2` 三、五对角回归；TASK-004 的五对角 API 防护与 14 用例；
- 阻断：许可证仍未固化；真实多 GPU 和 28→22 尚未完成。
...
- `ready` 软件任务：22 槽独立 pack/unpack 等价脚本、索引/尺寸上界检查；统一知识/数学检查入口已完成；
