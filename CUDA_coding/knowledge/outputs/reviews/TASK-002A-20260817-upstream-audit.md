...
日期：2026-08-17  
状态：完成；导师贡献/署名边界确认已于 2026-08-20 归档
...
> 我确认：初始五对角实现由李洋在本人指导的研究生团队三对角源码基础上，借助 AI 工具扩展形成。三对角基线及李洋在导入本项目之前完成的五对角实现，不应表述为本项目或后续执行者的独立原创；AI 工具不构成作者或权利主体。后续新增代码、验证和实验成果按实际贡献另行记录。论文署名与作者排序在投稿前另行确定。
>
> 确认人：苏运德
> 日期：2026-08-20

该确认解除 TASK-002A 的来源、署名和贡献边界人工项。它不授予公开发布许可、不替代 LICENSE/NOTICE 核验，也不决定论文最终作者排序；这些事项继续由 TASK-002B 处理。
